...
(3, 'None (Manual Placings)', 1, 34, NULL, NULL, NULL, NULL, 'score', 'DESC', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(27, 'Cut & Deduction', 3, 45, 'Each cut is input with a score and deduction', 'PureScore', 'PureScore', 'pointsFor', 'score', 'DESC', NULL, NULL, NULL, NULL, NULL, NULL, 'Score', 'score', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(1, 'weapon', 'Longsword', 1, 1, 1, 683, NULL, NULL),
(2, 'weapon', 'Messer', 1, 1, 1, 30, NULL, NULL),
(3, 'weapon', 'Sword and Buckler', 1, 1, 1, 141, NULL, NULL),
(5, 'weapon', 'Singlestick', 1, 1, 1, 60, NULL, NULL),
(6, 'weapon', 'Dagger', 1, 1, 1, 37, NULL, NULL),
(7, 'weapon', 'Saber', 1, 1, 1, 188, NULL, NULL),
(8, 'weapon', 'Smallsword', 1, 1, 1, 39, NULL, NULL),
(9, 'weapon', 'Grappling', 1, 1, 1, 1, NULL, NULL),
(10, 'weapon', 'Multiple Weapon', 1, 1, 1, 53, NULL, NULL),
...
(32, 'weapon', 'Longsword Cutting', 1, 1, 1, 56, NULL, NULL),
...
(56, 'weapon', 'Sidesword', 1, 1, 1, 49, NULL, NULL),
...
(61, 'weapon', 'Cutting', 1, 1, 1, 25, NULL, NULL),
...
(68, 'weapon', 'Armored', 1, 1, 1, 14, NULL, NULL),
...
(77, 'weapon', 'Dussack', 1, 1, 1, 11, NULL, NULL),
...
(81, 'weapon', 'Rapier & Dagger', 1, 1, 1, 96, NULL, NULL),
...
(91, 'weapon', 'Rapier (Single)', 1, 1, 1, 87, NULL, NULL),
(92, 'weapon', 'Rapier (Optional Dagger)', 1, 1, 1, 15, NULL, NULL),
(93, 'weapon', 'Rapier (Hybrid Offhand)', 1, 1, 1, 18, NULL, NULL),
...
(97, 'weapon', '1-H Medieval Sword', 1, 1, 1, 8, NULL, NULL),
...
(112, 'weapon', 'Experimental (TBD)', 1, 1, 1, 2, NULL, NULL),
...
(116, 'weapon', 'Mixed Weapon', 1, 1, 1, 17, NULL, NULL),
...
(130, 'weapon', 'Mixed Sword & Shield', 1, 1, 1, 1, NULL, NULL),
...
--
ALTER TABLE `eventAttacks`
  MODIFY `tableID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13565;
--
-- AUTO_INCREMENT for table `eventAttributes`
--
ALTER TABLE `eventAttributes`
  MODIFY `attributeID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4954;
--
-- AUTO_INCREMENT for table `eventBurgeeComponents`
--
ALTER TABLE `eventBurgeeComponents`
  MODIFY `burgeeComponentID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=309;
--
-- AUTO_INCREMENT for table `eventBurgeePlacings`
--
ALTER TABLE `eventBurgeePlacings`
  MODIFY `burgeePlaceID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73388;
--
-- AUTO_INCREMENT for table `eventBurgees`
--
ALTER TABLE `eventBurgees`
  MODIFY `burgeeID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
--
...
--
ALTER TABLE `eventDefaults`
  MODIFY `tableID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=906;
--
-- AUTO_INCREMENT for table `eventDescriptions`
--
ALTER TABLE `eventDescriptions`
  MODIFY `eventDescriptionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=262;
--
-- AUTO_INCREMENT for table `eventEventOptions`
--
ALTER TABLE `eventEventOptions`
  MODIFY `eventOptionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `eventExchanges`
--
ALTER TABLE `eventExchanges`
  MODIFY `exchangeID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=795050;
--
...
--
ALTER TABLE `eventGroupRoster`
  MODIFY `tableID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78411;
--
-- AUTO_INCREMENT for table `eventGroups`
--
ALTER TABLE `eventGroups`
  MODIFY `groupID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21225;
--
...
--
ALTER TABLE `eventIgnores`
  MODIFY `ignoreID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=666;
--
-- AUTO_INCREMENT for table `eventMatches`
--
ALTER TABLE `eventMatches`
  MODIFY `matchID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=214040;
--
-- AUTO_INCREMENT for table `eventMatchOptions`
--
ALTER TABLE `eventMatchOptions`
  MODIFY `matchOptionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1110;
--
-- AUTO_INCREMENT for table `eventPenaltyDisabled`
--
ALTER TABLE `eventPenaltyDisabled`
  MODIFY `penaltyDisabledID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;
--
-- AUTO_INCREMENT for table `eventPlacings`
--
ALTER TABLE `eventPlacings`
  MODIFY `placeID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37949;
--
-- AUTO_INCREMENT for table `eventPublication`
--
ALTER TABLE `eventPublication`
  MODIFY `publicationID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=376;
--
-- AUTO_INCREMENT for table `eventRatings`
--
ALTER TABLE `eventRatings`
  MODIFY `ratingID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24501;
--
-- AUTO_INCREMENT for table `eventRoster`
--
ALTER TABLE `eventRoster`
  MODIFY `rosterID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26425;
--
-- AUTO_INCREMENT for table `eventRosterAdditional`
--
ALTER TABLE `eventRosterAdditional`
  MODIFY `additionalRosterID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=221;
--
-- AUTO_INCREMENT for table `eventRules`
--
ALTER TABLE `eventRules`
  MODIFY `rulesID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=332;
--
-- AUTO_INCREMENT for table `eventRulesLinks`
--
ALTER TABLE `eventRulesLinks`
  MODIFY `rulesLinkID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=759;
--
-- AUTO_INCREMENT for table `eventScoresheets`
--
ALTER TABLE `eventScoresheets`
  MODIFY `scoresheetID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80184;
--
-- AUTO_INCREMENT for table `eventSettings`
--
ALTER TABLE `eventSettings`
  MODIFY `eventSettingID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=595;
--
-- AUTO_INCREMENT for table `eventSponsors`
--
ALTER TABLE `eventSponsors`
  MODIFY `eventSponsorID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
--
-- AUTO_INCREMENT for table `eventStandings`
--
ALTER TABLE `eventStandings`
  MODIFY `standingID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166104;
--
-- AUTO_INCREMENT for table `eventTeamRoster`
--
ALTER TABLE `eventTeamRoster`
  MODIFY `tableID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1662;
--
...
--
ALTER TABLE `eventTournamentComponents`
  MODIFY `tournamentComponentID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=184;
--
-- AUTO_INCREMENT for table `eventTournamentDivisions`
--
ALTER TABLE `eventTournamentDivisions`
  MODIFY `divisionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
-- AUTO_INCREMENT for table `eventTournamentDivItems`
--
ALTER TABLE `eventTournamentDivItems`
  MODIFY `divisionItemID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
--
-- AUTO_INCREMENT for table `eventTournamentOptions`
--
ALTER TABLE `eventTournamentOptions`
  MODIFY `tournamentOptionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1606;
--
-- AUTO_INCREMENT for table `eventTournamentOrder`
--
ALTER TABLE `eventTournamentOrder`
  MODIFY `tournamentOrderID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
--
-- AUTO_INCREMENT for table `eventTournamentRoster`
--
ALTER TABLE `eventTournamentRoster`
  MODIFY `tournamentRosterID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51292;
--
-- AUTO_INCREMENT for table `eventTournaments`
--
ALTER TABLE `eventTournaments`
  MODIFY `tournamentID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2341;
--
-- AUTO_INCREMENT for table `eventVideo`
--
ALTER TABLE `eventVideo`
  MODIFY `videoID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1411;
--
-- AUTO_INCREMENT for table `eventVideoStreams`
--
ALTER TABLE `eventVideoStreams`
  MODIFY `streamID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
--
-- AUTO_INCREMENT for table `logisticsAnnouncements`
--
ALTER TABLE `logisticsAnnouncements`
  MODIFY `announcementID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
--
-- AUTO_INCREMENT for table `logisticsBlockAttributes`
--
ALTER TABLE `logisticsBlockAttributes`
  MODIFY `blockAttributeID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=554;
--
-- AUTO_INCREMENT for table `logisticsFaq`
--
ALTER TABLE `logisticsFaq`
  MODIFY `faqID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `logisticsInstructors`
--
ALTER TABLE `logisticsInstructors`
  MODIFY `instructorID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT for table `logisticsLocations`
--
ALTER TABLE `logisticsLocations`
  MODIFY `locationID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=992;
--
-- AUTO_INCREMENT for table `logisticsLocationsBlocks`
--
ALTER TABLE `logisticsLocationsBlocks`
  MODIFY `blockLocationID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8060;
--
-- AUTO_INCREMENT for table `logisticsLocationsMatches`
--
ALTER TABLE `logisticsLocationsMatches`
  MODIFY `matchLocationID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28409;
--
...
--
ALTER TABLE `logisticsScheduleBlocks`
  MODIFY `blockID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3794;
--
-- AUTO_INCREMENT for table `logisticsScheduleShifts`
--
ALTER TABLE `logisticsScheduleShifts`
  MODIFY `shiftID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4620;
--
-- AUTO_INCREMENT for table `logisticsStaffCompetency`
--
ALTER TABLE `logisticsStaffCompetency`
  MODIFY `staffCompetencyID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4392;
--
-- AUTO_INCREMENT for table `logisticsStaffMatches`
--
ALTER TABLE `logisticsStaffMatches`
  MODIFY `matchStaffID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22884;
--
...
--
ALTER TABLE `logisticsStaffShifts`
  MODIFY `staffShiftID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7757;
--
...
--
ALTER TABLE `systemEvents`
  MODIFY `eventID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=565;
--
...
--
ALTER TABLE `systemOptionsList`
  MODIFY `optionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `systemRankings`
--
ALTER TABLE `systemRankings`
  MODIFY `tournamentRankingID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
-- AUTO_INCREMENT for table `systemRoster`
--
ALTER TABLE `systemRoster`
  MODIFY `systemRosterID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9344;
--
...
--
ALTER TABLE `systemSchools`
  MODIFY `schoolID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1286;
--
...
--
ALTER TABLE `systemTournaments`
  MODIFY `tournamentTypeID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
--
